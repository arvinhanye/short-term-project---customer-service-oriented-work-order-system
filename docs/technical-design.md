...
| `CategoryService` | 分类读取与管理员分类维护；统一校验权限、父分类存在性和严格两级层级规则 |
...
| 当前状态 | 可流转目标 |
| --- | --- |
| 0 待处理 | 1 处理中、2 已完成、3 已关闭、4 已取消 |
| 1 处理中 | 2 已完成、3 已关闭、4 已取消 |
| 2 已完成 | 3 已关闭 |
...
| `CategoryServiceTest` | 分类读取权限、严格两级规则、父级降级和删除保护 |
